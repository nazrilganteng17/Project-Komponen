<template>
  ...
  <div
    ...
    style="
      ...
      background-image: url('https://s3.amazonaws.com/busites_www/poison/gallery-media/vip-banner-5911-1575920188.jpg');
      height: 350px;
    ">
    <div
      ...
      <div class="flex h-full items-center justify-center">
        <div class="px-6 text-center text-white md:px-12">
          <h1 class="mb-6 text-5xl font-bold">WELCOME</h1>
          <h3 class="mb-8 text-3xl font-bold">POISON FOREVER</h3>
          <button
            type="button"
